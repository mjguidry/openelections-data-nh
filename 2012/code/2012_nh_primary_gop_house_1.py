...
url='http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26662'
...
results_dict=dict()
cols_dict=dict()
candidates=['Guinta','Shea-Porter','Clough','Parent','Scatter']
candidate_dict={'Guinta':{'name':'Frank C. Guinta' ,
                ...
                'Shea-Porter' :{'name':'Carol Shea-Porter',
                                'party':'D',
                                'winner':False},
                'Clough' :{'name':'Vern Clough',
                          'party':'R',
                          'winner':False},
                'Parent' :{'name':'Rick Parent',
                          'party':'R',
                          'winner':False},
...
# print 'Shea-Porter results ', sum([results_dict[x]['Shea-Porter'] for x in results_dict.keys()])
# print 'Guinta results ', sum([results_dict[x]['Guinta'] for x in results_dict.keys()])


import csv
csvfile=open(rep_dir+'/20120911__nh__republican__primary__house__1__town.csv','wb')
