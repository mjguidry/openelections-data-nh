...
urls=['http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26679',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26680',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26681',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26682',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26683',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26684',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26685',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26686',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26687',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26688'
      ]
...
import csv
csvfile=open(rep_dir+'/20120911__nh__republican__primary__state__house__town.csv','wb')
            ...
            if('totals' in str(ws.cell(row,0).value).lower() or row_test):
                ...
                for col in cols_dict:
                    ...
                    if(candidate in candidate_dict):
                        ...
                        if(bold==1 and candidate!='Scatter' and candidate_dict[candidate]['Party']=='R'):
