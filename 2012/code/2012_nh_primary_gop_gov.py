...
urls=['http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26653',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26654',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26655',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26656',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26657',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26658',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26659',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26660',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26661'
      ]
...
# print 'Lamontagne results ', sum([results_dict[x]['Lamontagne'] for x in results_dict.keys()])
# print 'Smith results ', sum([results_dict[x]['Smith'] for x in results_dict.keys()])


csvfile=open(rep_dir+'/20120911__nh__republican__primary__governor__town.csv','wb')
