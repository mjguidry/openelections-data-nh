...
urls=['http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=28513',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=28512',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26666',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=28511',
      'http://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=26668',
      ]
...
import csv
csvfile=open(rep_dir+'/20120911__nh__republican__primary__executive__council__town.csv','wb')
...
for url in urls:
    ...
    #                                candidate_dict[candidate]['Winner']=False
                        totals=[ws.cell(row,col).value for col in range(offset+1,offset+len(candidate_dict)+1)]
